...
function App() {
  ...
  return (
    <>
      ...
      <div className={`mx-3 md:container md:mx-auto my-5 rounded-xl p-5 transition-all duration-300 ease-in-out ${
        theme === 'dark' ? 'bg-gray-800 text-white' : 'bg-violet-100 text-black'
      } min-h-[80vh] md:w-[35%]`}>
        <h1 className='font-bold text-center text-3xl'>myTodo - Manage your todos</h1>
